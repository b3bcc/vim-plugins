...
""""""""""""""""""""""""
" “ªº¸±‡“Î/‘À––£¨F5±‡“Î£¨F6÷¥––£¨÷ß≥÷C/C++/Java/Python
" """"""""""""""""""""""""
func! CompileGcc()
    exec "w"
    let compilecmd="!gcc "
...
if has("cscope") && filereadable("/usr/bin/cscope")
    set csprg=/usr/bin/cscope " ÷∏∂®”√¿¥÷¥––cscopeµƒ√¸¡Ó 
    set csto=1                " œ»À—À˜tags±Í«©,‘ŸÀ—À˜cscope ˝æ›ø‚
    set cst                   "  π”√|:cstag|(:cs find g),∂¯≤ª «»± °µƒ:tag
    set nocsverb              " ≤ªœ‘ æÃÌº” ˝æ›ø‚ «∑Ò≥…π¶
" add any database in current directory
if filereadable("cscope.out")
    cs add cscope.out       " ÃÌº”cscope ˝æ›ø‚Œƒº˛
